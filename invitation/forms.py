...
class BaseInvitationKeyForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        self.delivery_backend = kwargs.pop('delivery', getattr(settings, 'INVITATION_DELIVERY_BACKEND', 'default'))
...
class DefaultInvitationKeyForm(BaseInvitationKeyForm):
    ...
    def clean(self):
        ...
        if self.remaining_invitations <= 0:
            raise forms.ValidationError(_("Sorry, you don't have any invitations left"))
