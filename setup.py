...
setup(
    ...
    version='1.0',
    description='''Built on top of django-registration, it restricts
    registration to a given number of invited person per active user (strategy
    introduced by GMail to involve 2.0 users).''',
    author='David Larlet',
